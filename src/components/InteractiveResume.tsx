...
export const InteractiveResume: React.FC<InteractiveResumeProps> = ({
	...
	return (
		<div className="min-h-screen bg-transparent text-foreground font-sans w-full">
			...
			{/* Main Layout */}
			<div className="relative z-10 w-full mx-auto flex flex-col lg:flex-row gap-12">
				{/* Left Content Column */}
				<main className="flex-1 min-w-0 lg:pr-64">
					{/* Compact Intro / Header */}
					<header
						id="intro"
						className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 pt-4 pb-8 border-b border-border scroll-mt-24"
					>
						<div className="mb-6 md:mb-0">
							<h1 className="text-4xl md:text-6xl font-black text-foreground tracking-tighter mb-2 font-mono">
								TASHIF AHMAD KHAN
							</h1>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
						<div>
							<SectionHeader id="education" title="Education" icon={BookOpen} />
						...
						<div>
							<SectionHeader id="positions" title="Leadership" icon={Layout} />
				...
				{/* Right Floating HUD (Fixed) */}
				<aside className="hidden lg:block fixed top-1/2 -translate-y-1/2 right-8 w-48 shrink-0 z-50">
					<div className="">
