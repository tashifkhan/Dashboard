...
> Source: https://deepwiki.com/tashifkhan/JIIT-time-table-website/9.1-google-calendar-integration
...
For information about the schedule generation process that creates the timetable data being synced, see [Schedule Generation](/tashifkhan/JIIT-time-table-website/4-schedule-generation-(core-feature)). For details about the academic calendar data format, see [Academic Calendar](/tashifkhan/JIIT-time-table-website/6-academic-calendar). For general export functionality including PDF and PNG downloads, see [PDF & PNG Export](/tashifkhan/JIIT-time-table-website/9.2-pdf-and-png-export).
