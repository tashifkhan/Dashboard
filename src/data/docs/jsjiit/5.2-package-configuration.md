...
> Source: https://deepwiki.com/codeblech/jsjiit/5.2-package-configuration

# Package Configuration

Relevant source files

* [.npmignore](https://github.com/codeblech/jsjiit/blob/d123b782/.npmignore)
...
The package configuration fields integrate tightly with the build system (see [Build System](/codeblech/jsjiit/5.1-build-system) for details):
