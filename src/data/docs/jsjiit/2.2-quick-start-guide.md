...
For detailed installation instructions, see [Installation](2.1-installation). For comprehensive API documentation of all available methods, see [API Reference](3-api-reference). For information about the internal architecture and security mechanisms, see [Architecture and Design](4-architecture-and-design).
...
1. **Explore all available methods**: See [API Reference](3-api-reference) for comprehensive documentation of all `WebPortal` methods
