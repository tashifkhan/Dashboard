...
> Source: https://deepwiki.com/codeblech/jsjiit/7.3-build-and-release-process
...
For detailed information about the build system architecture, see [Build System](/codeblech/jsjiit/5.1-build-system). For package.json configuration details, see [Package Configuration](/codeblech/jsjiit/5.2-package-configuration). For documentation deployment specifics, see [Automated Documentation Deployment](/codeblech/jsjiit/6.2-automated-documentation-deployment).
...
Test the built artifacts using the local development server (see [Local Development Setup](/codeblech/jsjiit/7.1-local-development-setup)):
...
* All tests pass in test.html (see [Testing and Validation](/codeblech/jsjiit/7.2-testing-and-validation))
