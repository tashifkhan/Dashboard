...
> Source: https://deepwiki.com/codeblech/jsjiit/4.2-encryption-and-security
...
For information about how the encrypted payloads are used in actual API methods, see [API Reference](/codeblech/jsjiit/3-api-reference). For details on the overall system architecture, see [System Architecture Overview](/codeblech/jsjiit/4.1-system-architecture-overview).
