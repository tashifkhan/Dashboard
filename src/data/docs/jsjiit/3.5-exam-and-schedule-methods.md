...
> Source: https://deepwiki.com/codeblech/jsjiit/3.5-exam-and-schedule-methods
...
* Attendance data: [Attendance Methods](/codeblech/jsjiit/3.3-attendance-methods)
* Grade and marks data: [Academic Records Methods](/codeblech/jsjiit/3.6-academic-records-methods)
* Registration data: [Registration and Subject Methods](/codeblech/jsjiit/3.4-registration-and-subject-methods)
...
For comprehensive error handling documentation, see [Error Handling](/codeblech/jsjiit/3.8-error-handling).
