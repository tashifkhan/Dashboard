...
While Navbar is covered in [Theme & Navigation Components](5.2-theme-and-navigation-components), it demonstrates composition patterns by using navigation features that could leverage Sheet for mobile menus or Popover for dropdowns.
