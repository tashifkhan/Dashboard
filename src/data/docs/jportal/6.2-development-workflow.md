...
> Source: https://deepwiki.com/codeblech/jportal/6.2-development-workflow
...
This page documents the development workflow for JPortal, including available npm scripts, local development procedures, code linting, production builds, and deployment to GitHub Pages. For information about PWA-specific build configuration and caching strategies, see [PWA Configuration](/codeblech/jportal/6.1-pwa-configuration).
