...
> Source: https://deepwiki.com/codeblech/jportal/5.1-custom-feature-components
...
This document covers the custom UI components built specifically for JPortal's feature modules. These components provide domain-specific visualizations and interactions for attendance tracking, grades display, and subject information. For base UI components from Radix UI (Dialog, Sheet, Select, etc.), see [Base UI Components](/codeblech/jportal/5.3-base-ui-components). For navigation and theme components, see [Theme & Navigation Components](/codeblech/jportal/5.2-theme-and-navigation-components).
...
These color classes are defined in the theme system (see [Theme System](/codeblech/jportal/3.4-theme-system)) and adapt to light/dark modes.
