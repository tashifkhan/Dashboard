...
> Source: https://deepwiki.com/codeblech/jportal/3.4-theme-system
...
For UI component styling patterns, see [Styling System](/codeblech/jportal/5.4-styling-system). For theme-related UI components themselves, see [Theme & Navigation Components](/codeblech/jportal/5.2-theme-and-navigation-components).
