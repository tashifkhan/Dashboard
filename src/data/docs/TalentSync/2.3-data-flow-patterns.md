...
For information about the overall system architecture, see [System Architecture](2-system-architecture). For specific backend service implementations, see [Backend Services](3-backend-services). For frontend component structure, see [Frontend Architecture](2.2-frontend-architecture).
