...
For database schema details related to user authentication, see [Database & Data Models](5-database-and-data-models). For role selection UI and middleware implementation specifically, see subsections [Role Selection & Management](4.2.4-role-selection-and-management) and [Middleware & Route Protection](4.2.5-middleware-and-route-protection).
