...
For information about the authentication flow prior to role selection, see [Login & OAuth](4.2.2-login-and-oauth). For details on how middleware enforces role-based access control, see [Middleware & Route Protection](4.2.5-middleware-and-route-protection).
