...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/3.1.1-text-extraction-and-cleaning
...
For information about the ML classification pipeline that follows text extraction, see [ML Classification Pipeline](/harleenkaur28/AI-Resume-Parser/3.1.2-ml-classification-pipeline). For comprehensive LLM-based analysis, see [Comprehensive Analysis with LLM](/harleenkaur28/AI-Resume-Parser/3.1.3-comprehensive-analysis-with-llm).
...
* **TF-IDF Vectorizer** for numerical feature extraction (see [ML Classification Pipeline](/harleenkaur28/AI-Resume-Parser/3.1.2-ml-classification-pipeline))
* **Regex extractors** for structured field parsing
* **LLM prompts** for semantic analysis (see [Comprehensive Analysis with LLM](/harleenkaur28/AI-Resume-Parser/3.1.3-comprehensive-analysis-with-llm))
