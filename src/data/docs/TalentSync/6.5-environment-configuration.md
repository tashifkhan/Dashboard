...
For information about the Docker images that consume these variables, see [Docker Images & Build Process](6.2-docker-images-and-build-process). For deployment automation that sets these variables, see [CI/CD Pipeline](6.3-cicd-pipeline). For monitoring configuration specifically, see [Monitoring & Analytics](6.6-monitoring-and-analytics).
