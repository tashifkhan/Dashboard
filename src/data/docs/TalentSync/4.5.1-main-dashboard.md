...
For information about navigation to this page, see [Middleware & Route Protection](4.2.5-middleware-and-route-protection). For details about individual feature pages accessible from this dashboard, see [Resume Upload & Analysis](4.5.2-resume-upload-and-analysis), [Cold Mail Generator](4.5.4-cold-mail-generator), and [Hiring Assistant](4.5.5-hiring-assistant).
