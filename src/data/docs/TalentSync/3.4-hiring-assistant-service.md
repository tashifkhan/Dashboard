...
This document covers the interview answer generation service. For resume analysis capabilities, see [Resume Analysis Service](3.1-resume-analysis-service). For cold email generation that also uses company research, see [Cold Mail Generator Service](3.3-cold-mail-generator-service). For the web search and content extraction agents used by this service, see [Support Agents](3.7-support-agents).
