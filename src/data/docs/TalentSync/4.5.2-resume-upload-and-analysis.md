...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/4.5.2-resume-upload-and-analysis
...
This page focuses on the initial upload and summary analysis. For detailed analysis visualization, see [Detailed Analysis View](/harleenkaur28/AI-Resume-Parser/4.5.3-detailed-analysis-view). For tips generation based on analysis, see [Career Tips](/harleenkaur28/AI-Resume-Parser/4.5.3-detailed-analysis-view). For the backend resume parsing and ML classification, see [Resume Analysis Service](/harleenkaur28/AI-Resume-Parser/3.1-resume-analysis-service).
...
* See: [Detailed Analysis View](/harleenkaur28/AI-Resume-Parser/4.5.3-detailed-analysis-view)
...
* See: [Cold Mail Generator](/harleenkaur28/AI-Resume-Parser/4.5.4-cold-mail-generator)
...
* Data: `resumeFile` metadata + `analysisData`
* See: [Hiring Assistant](/harleenkaur28/AI-Resume-Parser/4.5.5-hiring-assistant)
