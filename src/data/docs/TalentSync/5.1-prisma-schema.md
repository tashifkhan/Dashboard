...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/5.1-prisma-schema
...
For information about Pydantic data validation models used in the backend API, see [Data Models & Validation](/harleenkaur28/AI-Resume-Parser/5.2-data-models-and-validation). For deployment and database configuration, see [Environment Configuration](/harleenkaur28/AI-Resume-Parser/6.5-environment-configuration).
