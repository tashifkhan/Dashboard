...
For information about the authentication providers and session management, see [Login & OAuth](4.2.2-login-and-oauth). For details on how roles are assigned and updated, see [Role Selection & Management](4.2.4-role-selection-and-management).
