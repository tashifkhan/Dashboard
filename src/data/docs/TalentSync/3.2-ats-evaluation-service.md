...
For resume analysis and classification, see [Resume Analysis Service](3.1-resume-analysis-service). For generating tailored resumes based on ATS feedback, see [Tailored Resume Service](3.5-tailored-resume-service).
