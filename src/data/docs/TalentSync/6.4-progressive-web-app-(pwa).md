...
For information about the Next.js frontend application structure, see [Frontend Architecture](4-frontend-application). For deployment and build processes, see [Deployment & Infrastructure](6-deployment-and-infrastructure).
