...
For general AI/ML integration patterns, see [3.8](3.8-llm-integration-and-prompt-engineering). For other career enhancement features, see [3.4](3.4-hiring-assistant-service) (Hiring Assistant). For web search and GitHub agent implementations, see [3.7](3.7-support-agents).
...
For LLM configuration details, see [3.8](3.8-llm-integration-and-prompt-engineering).
