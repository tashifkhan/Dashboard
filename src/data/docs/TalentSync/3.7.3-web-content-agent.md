...
This page documents the Web Content Agent's architecture, implementation, and integration points. For web search functionality (URL discovery via Tavily), see [Web Search Agent](3.7.2-web-search-agent). For GitHub repository analysis, see [GitHub Agent](3.7.1-github-agent).
