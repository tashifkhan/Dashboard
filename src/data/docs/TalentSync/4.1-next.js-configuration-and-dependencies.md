...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/4.1-next.js-configuration-and-dependencies
...
For information about the overall frontend architecture and page routing structure, see [Frontend Architecture](/harleenkaur28/AI-Resume-Parser/4.2-authentication-system). For deployment and Docker build configuration, see [Docker Images & Build Process](/harleenkaur28/AI-Resume-Parser/6.2-docker-images-and-build-process). For analytics behavior tracking, see [Monitoring & Analytics](/harleenkaur28/AI-Resume-Parser/6.6-monitoring-and-analytics).
