...
* **Web Content Agent**: For extracting markdown from URLs ([3.7.3](3.7.3-web-content-agent))
* **LLM Core**: For summarizing research findings ([3.8](3.8-llm-integration-and-prompt-engineering))
