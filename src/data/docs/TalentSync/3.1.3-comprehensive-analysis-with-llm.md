...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/3.1.3-comprehensive-analysis-with-llm
...
This document explains how Google Gemini 2.0 Flash LLM is used to perform deep semantic analysis of resume text, transforming unstructured or semi-structured content into rich, structured data suitable for UI rendering and further processing. This step follows the ML classification pipeline (see [ML Classification Pipeline](/harleenkaur28/AI-Resume-Parser/3.1.2-ml-classification-pipeline)) and produces the final comprehensive analysis output.
...
| --- | --- | --- |
| **Cold Mail Generator** | Pre-fills email templates with skills and experience | [3.3](/harleenkaur28/AI-Resume-Parser/3.3-cold-mail-generator-service) |
| **Hiring Assistant** | Generates answers based on candidate's actual experience and projects | [3.4](/harleenkaur28/AI-Resume-Parser/3.4-hiring-assistant-service) |
| **ATS Evaluation** | Compares structured resume data against job description requirements | [3.2](/harleenkaur28/AI-Resume-Parser/3.2-ats-evaluation-service) |
| **Tailored Resume** | Uses comprehensive data as baseline, then optimizes for specific job | [3.5](/harleenkaur28/AI-Resume-Parser/3.5-tailored-resume-service) |
| **LinkedIn Services** | Converts projects and achievements into LinkedIn-ready content | [3.6](/harleenkaur28/AI-Resume-Parser/3.6-linkedin-services) |
