...
This page covers the cold email generation and editing functionality. For interview preparation features, see [Hiring Assistant Service](3.4-hiring-assistant-service). For resume analysis that feeds into this service, see [Resume Analysis Service](3.1-resume-analysis-service).
