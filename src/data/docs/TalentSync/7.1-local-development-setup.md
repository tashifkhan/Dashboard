...
For information about deployment and production configuration, see [Deployment & Infrastructure](6-deployment-and-infrastructure). For API documentation and testing endpoints, see [API Documentation](7.2-api-documentation).
...
1. **API Testing**: See [API Documentation](7.2-api-documentation) for endpoint reference
2. **Testing**: See [Testing Guide](7.3-testing-guide) for running tests
3. **Database Schema**: See [Prisma Schema](5.1-prisma-schema) for detailed model documentation
4. **Deployment**: See [Docker Compose Setup](6.1-docker-compose-setup) when ready to deploy
