...
For details on individual AI services that use these patterns (resume analysis, ATS evaluation, cold mail generation, etc.), see [3.1](3.1-resume-analysis-service) through [3.6](3.6-linkedin-services). For agent implementations, see [3.7](3.7-support-agents).
