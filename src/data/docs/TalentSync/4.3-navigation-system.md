...
For authentication-related routing and middleware protection, see [Middleware & Route Protection](4.2.5-middleware-and-route-protection). For information about dashboard layout and page organization, see [Dashboard Pages](4.5-dashboard-pages).
