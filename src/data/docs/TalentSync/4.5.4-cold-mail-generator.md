...
For backend cold mail generation service details including LLM integration and company research, see [3.3](3.3-cold-mail-generator-service). For the shared resume selection pattern used across features, compare with the Hiring Assistant implementation at [4.5.5](4.5.5-hiring-assistant).
