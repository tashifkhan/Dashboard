...
* ATS evaluation against job descriptions, see [ATS Evaluation Service](3.2-ats-evaluation-service)
* Resume tailoring and optimization, see [Tailored Resume Service](3.5-tailored-resume-service)
* Tips generation for resume improvement, see the tips generation endpoints in [Resume Analysis Service](3.1-resume-analysis-service)
