...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/2.1-backend-architecture
...
For information about specific AI services (Resume Analysis, ATS Evaluation, etc.), see [Backend Services](/harleenkaur28/AI-Resume-Parser/3-backend-services). For LLM integration patterns and prompt engineering, see [LLM Integration & Prompt Engineering](/harleenkaur28/AI-Resume-Parser/3.8-llm-integration-and-prompt-engineering). For deployment configuration, see [Deployment & Infrastructure](/harleenkaur28/AI-Resume-Parser/6-deployment-and-infrastructure).
