...
For information about user registration and email verification, see [Registration & Email Verification](4.2.1-registration-and-email-verification). For password reset functionality, see [Password Reset Flow](4.2.3-password-reset-flow). For middleware-based route protection, see [Middleware & Route Protection](4.2.5-middleware-and-route-protection).
...
This state machine shows all possible paths through the login system, including the role check that happens after session creation (handled by middleware, see [Middleware & Route Protection](4.2.5-middleware-and-route-protection)).
