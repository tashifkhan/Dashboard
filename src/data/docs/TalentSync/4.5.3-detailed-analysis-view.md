...
> Source: https://deepwiki.com/harleenkaur28/AI-Resume-Parser/4.5.3-detailed-analysis-view
...
The Detailed Analysis View displays comprehensive resume analysis results to authenticated users after their resume has been processed by the Resume Analysis Service (see [3.1](/harleenkaur28/AI-Resume-Parser/3.1-resume-analysis-service)). This page presents structured information including skills analysis, work experience, projects, education, and optional sections like publications, certifications, and achievements. Users access this view by navigating from the Resume Upload & Analysis page (see [4.5.2](/harleenkaur28/AI-Resume-Parser/4.5.2-resume-upload-and-analysis)) or directly via the route `/dashboard/analysis/[id]`.

This document covers the frontend implementation, data model, layout architecture, and rendering logic. For backend analysis processing, see [3.1.3](/harleenkaur28/AI-Resume-Parser/3.1.3-comprehensive-analysis-with-llm). For data persistence, see [5.1](/harleenkaur28/AI-Resume-Parser/5.1-prisma-schema).
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:1-31
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:111-147
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:33-109
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:194-828
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:149-828
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:242-271
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:274-318, [frontend/lib/markdown-renderer.tsx1-134](https://github.com/harleenkaur28/AI-Resume-Parser/blob/b2bbd83d/frontend/lib/markdown-renderer.tsx#L1-L134)
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:321-392
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:395-448
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:451-490
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:493-545
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:548-584
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:590-747
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:750-776
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:779-826
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:196-221
...
Sources: [frontend/lib/markdown-renderer.tsx1-134](https://github.com/harleenkaur28/AI-Resume-Parser/blob/b2bbd83d/frontend/lib/markdown-renderer.tsx#L1-L134) frontend/app/dashboard/analysis/[id]/page.tsx:304-576
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:196-227
...
Sources: frontend/app/dashboard/analysis/[id]/page.tsx:111-190
...
While the Detailed Analysis View itself doesn't write to localStorage, users typically arrive here from the Resume Upload page ([4.5.2](/harleenkaur28/AI-Resume-Parser/4.5.2-resume-upload-and-analysis)), which does cache the analysis data. This allows seamless transitions to other features that can pre-populate forms with the user's information.

**Related Pages:**

* For resume upload and initial analysis, see [4.5.2](/harleenkaur28/AI-Resume-Parser/4.5.2-resume-upload-and-analysis)
* For cold email generation using this data, see [4.5.4](/harleenkaur28/AI-Resume-Parser/4.5.4-cold-mail-generator)
* For interview preparation using this data, see [4.5.5](/harleenkaur28/AI-Resume-Parser/4.5.5-hiring-assistant)
* For backend analysis processing, see [3.1.3](/harleenkaur28/AI-Resume-Parser/3.1.3-comprehensive-analysis-with-llm)

Sources: frontend/app/dashboard/analysis/[id]/page.tsx:1-834