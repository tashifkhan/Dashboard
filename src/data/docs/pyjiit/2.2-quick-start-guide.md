...
For installation instructions, see [Installation](2.1-installation). For detailed authentication mechanics, see [Authentication Flow](2.3-authentication-flow). For comprehensive API documentation, see [Core API Reference](3-core-api-reference).
