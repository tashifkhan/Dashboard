...
> Source: https://deepwiki.com/codelif/pyjiit/3.1-webportal-class
...
This page documents the `Webportal` class structure, initialization, internal architecture, and all public methods. For session lifecycle and token management, see [Session Management](/codelif/pyjiit/3.2-session-management). For data structures returned by methods, see [Data Models](/codelif/pyjiit/3.3-data-models). For authentication workflow details, see [Authentication Flow](/codelif/pyjiit/2.3-authentication-flow).
