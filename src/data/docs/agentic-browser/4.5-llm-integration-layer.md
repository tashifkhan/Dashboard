...
This document covers the `LargeLanguageModel` class and the `PROVIDER_CONFIGS` registry. For environment variable configuration details, see [Configuration and Environment Variables](2.2-configuration-and-environment-variables). For usage within agent systems, see [React Agent Architecture](4.1-react-agent-architecture) and [Browser Use Agent](4.2-browser-use-agent-and-script-generation).
...
For detailed environment variable configuration, see [Configuration and Environment Variables](2.2-configuration-and-environment-variables).
