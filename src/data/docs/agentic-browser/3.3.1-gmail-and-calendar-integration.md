...
For information about the authentication mechanism that provides these access tokens, see [Settings and Authentication](2.2-configuration-and-environment-variables). For details on how the agent system dynamically loads these tools based on available credentials, see [Tool System](4.2-browser-use-agent-and-script-generation).
