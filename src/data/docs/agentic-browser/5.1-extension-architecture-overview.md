...
* Background script message handling: see [5.2](5.2-background-script-and-message-handling)
* Browser automation tool implementations: see [5.3](5.3-browser-automation-tools)
* Flask backend service details: see [5.4](5.4-extension-backend-service)
