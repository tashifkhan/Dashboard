...
For information about how this integrates with the agent intelligence system, see [Agent Intelligence System](4-agent-intelligence-system). For details on the LLM abstraction used with this data, see [LLM Integration](4.3-agent-tool-system).
...
2. **Agent Tool** - As part of the `websearch_agent` tool in the agent system (see [Tool System](4.2-browser-use-agent-and-script-generation))
