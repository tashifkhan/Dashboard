...
> Source: https://deepwiki.com/tashifkhan/agentic-browser/3.4-service-layer-architecture

# Service Layer Architecture

Relevant source files

* [services/calendar\_service.py](https://github.com/tashifkhan/agentic-browser/blob/e94826c4/services/calendar_service.py)
* [services/github\_service.py](https://github.com/tashifkhan/agentic-browser/blob/e94826c4/services/github_service.py)
* [services/gmail\_service.py](https://github.com/tashifkhan/agentic-browser/blob/e94826c4/services/gmail_service.py)
...
This document explains the Service Layer pattern used throughout the Agentic Browser backend. Services encapsulate business logic, coordinate between API routers and tool modules, and provide consistent error handling and logging. This layer sits between the FastAPI routers (documented in [3.3](/tashifkhan/agentic-browser/3.3-api-routers)) and the reusable tool modules (documented in [3.5](/tashifkhan/agentic-browser/3.5-tool-layer)).

For information about agent-specific service orchestration, see the React Agent Architecture ([4.1](/tashifkhan/agentic-browser/4.1-react-agent-architecture)).
