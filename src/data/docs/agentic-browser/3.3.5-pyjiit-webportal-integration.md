...
> Source: https://deepwiki.com/tashifkhan/agentic-browser/3.3.5-pyjiit-webportal-integration

# PyJIIT Webportal Integration

Relevant source files

* [routers/pyjiit.py](https://github.com/tashifkhan/agentic-browser/blob/e94826c4/routers/pyjiit.py)
...
For information about how PyJIIT is used as an agent tool within the React Agent system, see [Agent Tool System](/tashifkhan/agentic-browser/4.3-agent-tool-system). For details on the PyJIIT router's role in the overall API architecture, see [API Routers](/tashifkhan/agentic-browser/3.3-api-routers).
...
For details on how the PyJIIT tool is constructed and used within the agent workflow, see [Agent Tool System](/tashifkhan/agentic-browser/4.3-agent-tool-system) and [Dynamic Tool Construction and Context Management](/tashifkhan/agentic-browser/4.4-dynamic-tool-construction-and-context-management).
