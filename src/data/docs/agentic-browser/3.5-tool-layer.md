...
For information about how the Service Layer uses these tools, see [Service Layer Architecture](3.4-service-layer-architecture). For agent-specific tool wrappers used by the React Agent, see [Agent Tool System](4.3-agent-tool-system).
