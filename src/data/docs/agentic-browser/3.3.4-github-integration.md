...
For information about other API routers, see [API Routers](3.3-api-routers). For details on the LLM integration used by this service, see [LLM Integration Layer](4.5-llm-integration-layer).
...
The GitHub functionality is also exposed as an agent tool for use by the React Agent system (see [Agent Tool System](4.3-agent-tool-system)).
