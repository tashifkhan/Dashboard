...
For information about configuring environment variables and API keys after installation, see [Configuration and Environment Variables](2.2-configuration-and-environment-variables). For instructions on running the application after installation, see [Running the Application](2.3-running-the-application).
...
For next steps, proceed to [Configuration and Environment Variables](2.2-configuration-and-environment-variables) to set up API keys and environment settings, then [Running the Application](2.3-running-the-application) to start the server.
